import { z } from 'zod';
import { ConfigParser, ConfigUtils } from '../../src/lib/parser';
import type { TaskConfig } from '../../src/lib/types/index';
...
describe('ConfigUtils', () => {
  ...
  describe('validateCompleteness', () => {
    ...
    it('should identify incomplete config', () => {
      ...
      expect(result.issues).toContain('Missing script name');
      expect(result.issues).toContain('Missing script signature');
