  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center min-h-[400px]">
        ...
        <p className="mt-4 text-sm font-medium text-[var(--cds-text-secondary)]">Loading available tasks...</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center min-h-[400px]">
        <div className="mb-4 rounded-full bg-red-50 p-3">
          <svg className="h-6 w-6 text-[var(--cds-error)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          ...
          className="text-sm font-semibold text-[var(--cds-primary)] hover:underline"
        >
          Try again
        </button>
      </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center min-h-[400px] bg-white rounded-2xl border border-[var(--cds-border)] border-dashed">
        <div className="h-12 w-12 rounded-full bg-gray-50 flex items-center justify-center mb-4">
          <svg className="h-6 w-6 text-[var(--cds-text-tertiary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
        </div>
        <h3 className="text-lg font-semibold text-[var(--cds-text-primary)]">No tasks found</h3>
        <p className="text-sm text-[var(--cds-text-secondary)] mt-1">There are no tasks currently ready to sign.</p>
      </div>
    );
  }
              ...
              <div className="flex items-start justify-between gap-6">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <Badge variant="neutral" size="sm" className="uppercase tracking-wider text-[10px] font-bold">
                      {option.network}
                    </Badge>
                  ...
                  <div className={`text-sm text-[var(--cds-text-secondary)] prose prose-sm max-w-none prose-a:text-[var(--cds-primary)] prose-a:no-underline hover:prose-a:underline ${!isExpanded ? 'line-clamp-2' : ''}`}>
                  ...
                  {option.description.length > 150 && (
                    <button
                      ...
                      className="mt-2 text-xs font-medium text-[var(--cds-primary)] hover:text-[var(--cds-primary-hover)] focus:outline-none"
                    >
    ...
    return (
       <div className="relative group/dropdown">
         <Badge variant={variant} className="cursor-pointer hover:opacity-80">
            ...
            <svg className="ml-1 w-3 h-3 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
